...
You can also download the latest release from GitHub [releases page](https://github.com/szimek/signature_pad/releases) or go to the latest release tag (e.g. [v1.6.0](https://github.com/szimek/signature_pad/tree/v1.6.0)) and download  `signature_pad.js` or `signature_pad.min.js` files directly.
